...
@endphp
    <div class="box-border sm:px-0 px-1">
        ...
        <div class="border-b-2 border-gray-300 h-20 w-full flex items-center justify-end sm:px-20 px-4 box-border">
            <div class="w-full">
                <form method="POST" action="{{ route('logout') }} >
                    @csrf
                    <button type="submit" class=" ml-6 bg-gray-200 rounded-lg text-sm p-2 border-1 border-gray-300">Sign Out <i class="ml-4 text-black mdi mdi-logout" ></i></button>
                </form>
            </div>
        </div>
        <div class="flex sm:flex-row flex-col h-screen px-4">
            ...
            <div class="sm:w-[60%] w-full">
                <h1 class=" text-xl font-bold mb-4 mt-4">Post</h1>
